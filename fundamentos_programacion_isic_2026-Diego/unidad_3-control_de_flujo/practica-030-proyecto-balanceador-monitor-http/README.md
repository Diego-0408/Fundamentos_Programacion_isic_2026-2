# Práctica 030: Proyecto: Balanceador de carga y monitor HTTP
...
Se integraron bucles anidados y condiciones para simular un balanceador de carga que valida límites de capacidad máxima por servidor y totaliza el tráfico global del clúster.
# Práctica 023: Monitor de latencia Ping de red.
...
El programa emplea un ciclo Para de 5 iteraciones para procesar un lote fijo de pruebas de latencia. Utiliza un acumulador para sumar los tiempos y un condicional para detectar la latencia máxima, permitiendo calcular el promedio y mostrar el peor caso al finalizar.
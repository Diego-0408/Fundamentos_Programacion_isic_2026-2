# Práctica 024: Temporizador regresivo de apagado de servidor
...
El programa implementa un bucle Para con paso negativo (Con Paso -1) para decrementar de forma iterativa el tiempo ingresado por el usuario hasta alcanzar el cero, mostrando el conteo segundo a segundo y cerrando con el mensaje de apagado correcto del servidor.
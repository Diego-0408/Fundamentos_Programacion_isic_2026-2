# Práctica 03: Punto de venta de equipo tecnologico
...
Este algoritmo recoplia el valor de 3 productos distintos y a partir de ahi hace un proceso de operciones aritmeticas para poder calcular rapidamente el subtotal de los productos, el coste del IVA, el coste de envio y el monto total a pagar en una dicha ordenada.
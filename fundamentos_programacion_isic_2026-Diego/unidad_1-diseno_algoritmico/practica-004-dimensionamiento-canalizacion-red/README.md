# Práctica 04: Dimensionamiento de canalizacion para redes de fibra optica
...
Este Algoritmo permite el caluclo de del area base, area lateral y volumen de un conducto cilindrico para acelerar los procesos mediante una serie de operaciones y asignaciones en el codigo, con solo introducir el radio y la longitud permite hacer todo esto y realizar los calculos.